...
const migrateSave = (data: Record<string, unknown>): GameSave => {
  ...
  if (version === 1) {
    ...
    return {
      ...
      locations: [
        { id: 'whispering_forest', isDiscovered: true, isUnlocked: true, explorationProgress: 0, secretsFound: [], visitCount: 0 },
        { id: 'drowned_ruins', isDiscovered: false, isUnlocked: false, explorationProgress: 0, secretsFound: [], visitCount: 0 },
        { id: 'bellless_tower', isDiscovered: false, isUnlocked: false, explorationProgress: 0, secretsFound: [], visitCount: 0 },
      ],
      expedition: null,
      inventory: [],
      collections: [],
